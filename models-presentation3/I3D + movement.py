...
def define_joint_model():
    ...
    MLP.add(Flatten())
    MLP.add(Dropout(0.5))
    # TODO: Possibly also regularize these layers
    MLP.add(Dense(256, activation = "relu"))
    MLP.add(Dense(13, activation="softmax"))

    # (45 frames, 32 wide, 32 high, 3 channels)
    vid_inputs = Input((45, 32, 32, 3))
    # (45 frames, 9 channels, see preprocess-movement.py)
    mvm_inputs = Input((45, 9))

    # CNN extracts 512 video features for each frame
    # This contains a bunch of 3d convolutional layers
    # TODO: These will need to be regularized
